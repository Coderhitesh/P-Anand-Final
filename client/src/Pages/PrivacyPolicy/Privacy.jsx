                ...
                <div className="col-lg-12 col-md-10">
                    <div className="card shadow-sm">
                        <div className="card-body p-3">
                            ...
                            <p><strong>P Anand Academy</strong> is a division of P Anand Academy located at P Anand Academy Building, XYZ Street, Delhi 110092.</p>
                            ...
                            <p>P Anand Academy uses cookies to help identify and track visitors, their usage of <strong>www.panandacademy.edu.in</strong>, and their website access preferences. By continuing to navigate our website without changing your cookie settings, you acknowledge and agree to our use of cookies.</p>
