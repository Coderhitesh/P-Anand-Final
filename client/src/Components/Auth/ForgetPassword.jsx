...
const ForgetPassword = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post("https://www.api.panandacademy.hoverbusinessservices.com/api/v1/Password-Change", formData)
    ...
    const handleOTPSubmit = async (otpevent) => {
        ...
        try {
            const response = await axios.post(`https://www.api.panandacademy.hoverbusinessservices.com/api/v1/Verify-Otp/${formData.Email}/${formData.NewPassword}`, formData)
            console.log(response.data);
            setLoading(false);
            toast.success(response.data.msg)
    ...
    const resendOTP = async (otpevent) => {
        ...
        otpevent.preventDefault()
        try {
            const response = await axios.post(`https://www.api.panandacademy.hoverbusinessservices.com/api/v1/resend-otp/`, formData)
            console.log(response.data);
            setLoading(false);
