      ...
      <header>
        ...
        <div className={`rightNav ${sidetoggle ? "active" : "" } `  }>
          <ul>
            ...
            <li><Link to="/all-category" onClick={handletoggleBtn}> <i className="fa-solid fa-tag me-1 "></i> Manage Course Category</Link></li>
            <li><Link to="/all-book-category" onClick={handletoggleBtn}> <i className="fa-solid fa-tag me-1 "></i> Manage Book Category</Link></li>
            <li><Link to="/all-bundle" onClick={handletoggleBtn}> <i className="fa-solid fa-tag me-1 "></i> Manage Course Bundle</Link></li>
            <li><Link to="/all-book-bundle" onClick={handletoggleBtn}> <i className="fa-solid fa-tag me-1 "></i> Manage Book Bundle</Link></li>
            ...
            <li><Link to="/all-tags" onClick={handletoggleBtn}> <i className="fa-solid fa-tag me-1 "></i> Manage Course Tags</Link></li>
