...
const AllPartners = () => {
  ...
  const handleFetch = async () => {
    try {
      const res = await axios.get('https://www.api.panandacademy.hoverbusinessservices.com/api/v1/get-all-company-logos');
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(`https://www.api.panandacademy.hoverbusinessservices.com/api/v1/delete-company-logo/${selectedLogoId}`);
      handleFetch();
  ...
  const handleUpload = async () => {
    try {
      ...
      await axios.post('https://www.api.panandacademy.hoverbusinessservices.com/api/v1/upload-logo-of-Company', formData);
      handleFetch();
