...
const EditShopBanner = () => {
    ...
    const handleFetch = async () => {
        try {
            const res = await axios.get(`https://www.api.panandacademy.hoverbusinessservices.com/api/v1/get-all-sale-banner`);
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.put(`https://www.api.panandacademy.hoverbusinessservices.com/api/v1/update-sale-banner/${id}`, data);
