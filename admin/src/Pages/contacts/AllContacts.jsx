...
const AllContacts = () => {
    const backend = 'https://www.api.panandacademy.hoverbusinessservices.com/api/v1/get-contact';
    const deleteRoute = 'https://www.api.panandacademy.hoverbusinessservices.com/api/v1/delete-contact/';
    const addMessageRoute = 'https://www.api.panandacademy.hoverbusinessservices.com/api/v1/push-Message/';
