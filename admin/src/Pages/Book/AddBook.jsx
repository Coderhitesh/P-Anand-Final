...
function AddBook() {
    ...
    const handleCategoryChange = async (e) => {
        ...
        if (value) {
            try {
                const response = await axios.get(`https://www.api.panandacademy.hoverbusinessservices.com/api/v1/single-book-category/${value}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('https://www.api.panandacademy.hoverbusinessservices.com/api/v1/create-book', formDataToSend, {
                headers: {
