...
const MessageTemplate = () => {
    ...
    const handleFetchTemplates = async () => {
        try {
            const res = await axios.get('https://www.api.panandacademy.hoverbusinessservices.com/api/v1/get-all-templates');
    ...
    const handleDeleteTemplate = async () => {
        try {
            await axios.delete(`https://www.api.panandacademy.hoverbusinessservices.com/api/v1/delete-template/${selectedTemplate._id}`);
    ...
    const handleSendTemplate = async (_id) => {
        try {
            await axios.post('https://www.api.panandacademy.hoverbusinessservices.com/api/v1/send-emails-in-batches', {
                id: _id
            });
