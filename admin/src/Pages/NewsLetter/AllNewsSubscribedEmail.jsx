...
const AllNewsSubscribedEmail = () => {
    ...
    const handleFetch = async () => {
        try {
            const res = await axios.get('https://www.api.panandacademy.hoverbusinessservices.com/api/v1/get-all-subscribe-newsletter-email');
    ...
    const handleDelete = async () => {
        try {
            await axios.delete(`https://www.api.panandacademy.hoverbusinessservices.com/api/v1/delete-newsletter-email/${selectedEmailId}`);
            handleFetch();
