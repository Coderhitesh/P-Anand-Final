...
function EditCourseRating() {
  ...
  const fetchCourseRating = async () => {
    try {
      const res = await axios.get(`https://www.api.panandacademy.hoverbusinessservices.com/api/v1/get-single-course-rating/${id}`);
      setFormData({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(`https://www.api.panandacademy.hoverbusinessservices.com/api/v1/update-course-rating/${id}`, {
