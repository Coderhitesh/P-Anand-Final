...
function AddBookTag() {
    ...
    const fetchTags = async () => {
        try {
            const response = await axios.get('https://www.api.panandacademy.hoverbusinessservices.com/api/v1/get-all-tag');
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post('https://www.api.panandacademy.hoverbusinessservices.com/api/v1/create-book-tag', formData);
            setIsLoading(false);
            ...
            <div className="d-form">
                <form className="row g-3" onSubmit={handleSubmit}>
                    <div className="col-md-6">
                        <label htmlFor="tagName" className="form-label">Book Tag Name</label>
