...
function EddTeacherRate() {
  ...
  const fetchTeacherRating = async () => {
    try {
      const res = await axios.get(`https://www.api.panandacademy.hoverbusinessservices.com/api/v1/get-single-teacher-rating/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(`https://www.api.panandacademy.hoverbusinessservices.com/api/v1/update-teacher-rating/${id}`, data);
      setIsLoading(false);
