...
function EditBookCategory() {
    ...
    const handleFetch = async () => {
        try {
            const res = await axios.get(`https://www.api.panandacademy.hoverbusinessservices.com/api/v1/single-book-category/${id}`);
    ...
    const updateCategory = async (data) => {
        try {
            const response = await axios.put(`https://www.api.panandacademy.hoverbusinessservices.com/api/v1/update-book-category/${id}`, data, {
                headers: {
