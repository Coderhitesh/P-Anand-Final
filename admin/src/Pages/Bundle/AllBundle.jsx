...
function AllBundle() {
    ...
    const handleFetchBundle = async () => {
        try {
            ...
            const initialSelectedModes = {};
            reverseData.forEach(bundle => {
                if (bundle.bundleMode && bundle.bundleMode.length > 0) {
                    initialSelectedModes[bundle._id] = bundle.bundleMode[0]._id;
                }
            });
    ...
    const handleDelete = async (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    await axios.delete(`https://www.api.panandacademy.hoverbusinessservices.com/api/v1/delete-bundle/${id}`);
