...
const EditBundle = () => {
  ...
  useEffect(() => {
    ...
    const fetchBundleData = async () => {
      try {
        const res = await axios.get(`https://www.api.panandacademy.hoverbusinessservices.com/api/v1/single-bundle/${id}`);
  ...
  useEffect(() => {
    // Fetch tags, categories, and courses
    const fetchData = async () => {
      try {
        const [tagsResponse, categoriesResponse, coursesResponse] = await Promise.all([
          axios.get('https://www.api.panandacademy.hoverbusinessservices.com/api/v1/get-all-tag'),
          axios.get('https://www.api.panandacademy.hoverbusinessservices.com/api/v1/get-all-category'),
          axios.get('https://www.api.panandacademy.hoverbusinessservices.com/api/v1/get-all-course')
        ]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(`https://www.api.panandacademy.hoverbusinessservices.com/api/v1/update-bundle/${id}`, data, {
        headers: {
