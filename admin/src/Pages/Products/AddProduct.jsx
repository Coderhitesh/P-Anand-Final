...
const AddProduct = () => {
    ...
    const handleCategoryChange = async (e) => {
        ...
        if (value) {
            try {
                const response = await axios.get(`https://www.api.panandacademy.hoverbusinessservices.com/api/v1/single-category/${value}`);
    ...
    const handleCourseModeChange = (index, e) => {
        ...
        setFormData((prevFormData) => {
            const updatedCourseMode = [...prevFormData.courseMode];
    ...
    const addCourseMode = () => {
        setFormData((prevFormData) => ({
            ...prevFormData,
            courseMode: [...prevFormData.courseMode, { modeId: '', modeType: '', coursePrice: '', coursePriceAfterDiscount: '', courseDiscountPercent: '', courseLink: '' }]
        }));
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('https://www.api.panandacademy.hoverbusinessservices.com/api/v1/create-course', formDataToSend, {
                headers: {
