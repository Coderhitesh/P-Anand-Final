...
function AddBookBundle() {
    ...
    const handleCategoryChange = async (e) => {
        ...
        if (value) {
            try {
                const res = await axios.get(`https://www.api.panandacademy.hoverbusinessservices.com/api/v1/get-book-by-category/${value}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('https://www.api.panandacademy.hoverbusinessservices.com/api/v1/create-book-bundle', formDataToSend, {
                headers: {
